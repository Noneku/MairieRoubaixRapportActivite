 ...
 */
final class Version20231030152232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rapport_activite (id INT AUTO_INCREMENT NOT NULL, url_index_id INT DEFAULT NULL, mission_principale LONGTEXT NOT NULL, indicateur LONGTEXT NOT NULL, realisation LONGTEXT NOT NULL, perspective LONGTEXT NOT NULL, donnees_finance LONGTEXT DEFAULT NULL, donnees_rh LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, indicateur_file LONGBLOB DEFAULT NULL, realisation_file LONGBLOB DEFAULT NULL, perspective_file LONGBLOB DEFAULT NULL, UNIQUE INDEX UNIQ_6CB5B597E6531CE8 (url_index_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
